<template>
    <div class="bg-slate-50 my-16">
        <section id="project" class="py-8">
            <div class="flex justify-center items-center flex-col">
                <h3 class="text-primary font-bold lg:text-xl">Portfolio</h3>
                ...
                <div class="flex flex-wrap">
                    <div class="w-full py-6 sm:px-6 md:w-1/2">
                        <a href="#" class="hover:opacity-80 transition-all">
                            <img class="my-4 rounded-sm shadow-md " id="project1" src="../assets/project_brives.png" alt="Brive">
                        </a>
                            <h5 class="block font-semibold text-lg" for="project1">BRIVES</h5>
